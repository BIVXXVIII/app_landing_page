...
export default function SliderCard({ img, size, className, ...rest }: Props) {
    const wrapperSizeClasses: ParamsClasses = {
    ...
    const imageClasses: ParamsClasses = {
    ...
    return (
        <div className={`${wrapperSizeClasses[size]} ${className}`} {...rest} >
            <img src={img} alt='app mockup img' className={imageClasses[size]} />
        </div >
    )
}